<?php
/**
* Template File: Tina MVC Wordpress admin pages - index page.
*
* @package  Tina-MVC
* @subpackage Docs
*/
...
<p>Documentation is now included with the plugin and is accessed from the Wordpress admin pages.</p>

<h3>Documentation</h3>

<ol>
 <li><a href="?page=tina_mvc_hello_world">The "Hello World!" Tutorial</a></li>
 <li><a href="?page=tina_mvc_using_views">Using Views</a></li>
 <li><a href="?page=tina_mvc_adding_models">Adding Models</a></li>
...
<?php foreach( TINA_MVC\get_tina_mvc_setting('tina_mvc_pages') AS $n => $p ): ?>
<?php if( is_int( $n ) ): ?>
