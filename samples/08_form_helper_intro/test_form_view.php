<?php
/**
 * A trivial view file for the test_form controller
 *
 * @package    Tina-MVC
 * @subpackage Samples
...
<p>This formn is posted back to this page. The page is updated with the results of POSTed data without sending a browser redirect.
